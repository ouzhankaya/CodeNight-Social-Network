using CodeNight.DataAccessLayer.EntityFramework.EntityFramework;
...
using CodeNight.BusinessLayer.Abstract;
using Common;
        ...
        public BusinessLayerResult<User> UserRegister(RegisterViewModel data)
        {
            ...
            else
            {
                ...
                if (dbResult > 0)
                {
                    ...
                    MailHelper.SendMail(body, res.Result.Email, "Code Night Hesap Aktifleştirme");
                }
            }
            return res;
        }
